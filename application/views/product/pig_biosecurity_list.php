              ...
              <div class="row">
                ...
                <div class="item col-md-4">
                  <div class="product-image"><center>
                    <a href="#"> <img src="../<?php echo base_url('assets/images/'); ?>products/swine/ocide_S.jpg" alt="Ocid-S" ></a></center>
                  </div>
                  <div class="product-info">                   
                      <div class="header">
                        <h2 class="product-name">Ocid-S</h2><br>
                        <h3 class="product-tagline">Cationic polymer with biocide properties</h3>
                      </div>
                      <div class="desc std">
                        <b>Benefits</b>
                        <ul class="benefits">
                            <li>Cleans shed effectively to prevent infections to adults and neonates </li>
                            <li>Sanitization of utensils and equipment</li>                       
                            <li>Optimizes FCR</li>                       
                            <li>Safe to use in presence of animals. Contains to harmful fumes</li>
                          </ul><br>
                        <span class="hide more_info span2 " id="more_info">
                          <b>Feeding Instruction</b>
                          <ul class="feeding">
                              <li>Empty shed: 20 ml / ltr</li>
                              <li>Spray in animals: 2 ml / ltr</li>
                              <li>Equipment Wash: 2 ml / ltr</li>
                          </ul><br>
                          <b> pakaging</b>
                          <ul class="packaging">
                              <li>Available as 500ml, 1L and 5L packs</li>
                          </ul><br> 
                        </span>
                        <div align="right">
