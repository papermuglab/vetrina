                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Products <span class="caret"></span></a>
                     <ul class="dropdown-menu">
                      ...
                      <li><a href="swine.html" class="active">Swine</a></li>
          ...
          <div class="col-md-4">
            <div class="product_item">
             ...
             <div class="item-detail ">
              ...
              <a href="pig_feedsupplement_list.html" class="w3-display-bottomright btn btn-primary">Products</a>
             </div>
           </div>
          </div>
          <!-- <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="product_item ">
             ...
             <div class="item-detail">
              ...
              <a href="pig_biosecurity_list.html" class="w3-display-bottomright btn btn-primary">Products</a>
            </div>
           </div>
          </div>
          <div class="col-md-2"></div>
