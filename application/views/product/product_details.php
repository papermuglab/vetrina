  ...
  <body>
    ...
    <section class="container">
      <div class="">      
        <div class="row">
          <div class="col-md-4">
            <div class="dummyimg"><img src="<?php echo base_url('assets/images/'); ?>cattle.jpg" class="img-responsive"></div>
          </div>
          <div class="col-md-8">
            <h3>Product Name</h3>
            ...
            <br>
             <h3>Product info</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrude consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
           <!--  <div class="text-center">Generating Tomorrow's Solution Today...</div> -->
          </div>
        </div>
      </div>
    </section>
