              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a href="product/companian_animal.html">Companion Animals</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="container-fluid margin-top-30 margin-bottom-30" id="products">
          ...
          <ul class="mainProducts">
            <li>
              <a href="product/cattle.html"><i class="productIcons cowIcon"></i></a>
              <div>Cattle</div>
            </li>
            <li>
              <a href="product/sheep.html"><i class="productIcons sheepIcon"></i></a>
              <div>Sheep and Goats</div>
            </li>
            <li>
              <a href="product/poultry.html"><i class="productIcons poultryIcon"></i></a>
              <div>Poultry</div>
            </li>
            <li>
              <a href="product/companian_animal.html"><i class="productIcons dogIcon"></i></a>
              <div>Companian Animals</div>
            </li>
            <li>
              <a href="product/exotic_animal.html"><i class="productIcons exoticIcon"></i></a>
              <div>Exotic Animals</div>
            </li>
            <li>
              <a href="product/swine.html"><i class="productIcons pigIcon"></i></a>
              <div>Swine</div>
            </li>
          </ul>
