        ...
        <section class="post blog-post col-lg-8"> 
          <!-- <div class="container"> -->
            <div class="post-single">
              <div class="post-thumbnail"><img src="<?php echo base_url('assets/images/'); ?>blogs/blog-post-3.jpeg" alt="..." class="img-fluid"></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#">Business </a><a href="#">Financial</a></div>
                </div>
                <h1>Diversity in Engineering: The Effect on Questions<a href="#"><i class="glyphicon glyphicon-bookmark"></i></a></h1>
               <!--  <div class="post-footer d-flex align-items-center flex-column flex-sm-row"><a href="#" class="author d-flex align-items-center flex-wrap">
                  ...
                  <div class="d-flex align-items-center flex-wrap">       
                    ...
                    <div class="views"> <i class="glyphicon glyphicon-eye-open"></i> 500</div>
                    <div class="comments meta-last"> <i class="glyphicon glyphicon-comment"></i> 12 </div>
                  </div>
                </div> -->
                ...
                <div class="post-body">
                  ...
                  <p> <img src="<?php echo base_url('assets/images/'); ?>blogs/featured-pic-3.jpeg" alt="..." class="img-fluid"></p>
                  ...
                  <div class="comment">
                    <div class="comment-header d-flex justify-content-between">
                      <div class="user d-flex align-items-center">
                        <div class="image"><img src="<?php echo base_url('assets/images/'); ?>blogs/user.svg" alt="..." class="img-fluid rounded-circle"></div>
