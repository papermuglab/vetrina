            ...
            <div class="form_container">
              <form class="career_form" id="career_form">
                ...
                <div class="input-group input-group-lg">
                  ...
                  <textarea  class="form-control" placeholder="Profession" aria-describedby="sizing-addon1" required></textarea>
                </div>
                <div class="input-group input-group-lg">
                  <span class="input-group-addon" id="sizing-addon1">Resume</span>
                  <input type="file" id="resume" class="form-control" placeholder="Resume" aria-describedby="sizing-addon1" required>
                </div>
